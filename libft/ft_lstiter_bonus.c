...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/11/08 19:15:42 by rstarcev          #+#    #+#             */
/*   Updated: 2025/11/08 22:41:09 by rstarcev         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_test_putstr(void *s)
{
	write(1, (char *)s, ft_test_strlen((char *)s));
	write(1, "\n", 1);
}
 */
...
{
	ft_lstiter(root, &ft_test_putstr);
}
